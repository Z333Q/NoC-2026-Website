...
const team = [
  {
    ...
    bio: 'Technical founder with 20+ years building financial infrastructure. Co-founded ReFi.Trading (USPTO patent for AI trading systems). Founder and builder of P402.io, a payment protocol for agentic commerce. Deployed mobile banking to rural markets at Symstream, and led $1.2B+ in transactions at Peak Venture Partners. Professor at Kutaisi International University teaching AI, blockchain, and product development.',
